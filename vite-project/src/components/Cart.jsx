...
function Cart() {
  ...
  const productData = hasItems ? Cartdata.items[0].productData : null;
  ...
  for (let i = 0; i < Cartdata.items.length; i++) {
    ...
    finalPrice += Cartdata.items[i].productData.finalPrice;
  }
              ...
              <div className="ml-4">
                ...
                <div className="relative">
                  <h1 className="text-gray-400">
                    M.R.P : ₹{item.productData.price} (inclusive of all taxes)
                  </h1>
                ...
                <div className="flex items-center justify-between">
                  <div className="rounded-md mt-4 border-2 border-green-600 w-fit">
                    ...
                    <div className="relative px-6">
                      <h1 className="text-gray-400">
                        M.R.P : ₹{item.productData.price} (inclusive of all
                        taxes)
                      </h1>
                      <span className="w-10 h-[1px] ml-12 bg-gray-600 absolute top-1/2"></span>
                    </div>
                  ...
                  <MdDeleteOutline
                    ...
                    className="text-5xl cursor-pointer mt-8 text-red-600"
                  />
                </div>
              </div>
            </div>
      ...
      {hasItems && productData ? (
        <div className="fixed border-2 shadow-xl w-[400px] px-6   py-4 right-20 top-48">
          ...
          <div className="flex mt-2 text-lg font-semibold text-gray-600 justify-between">
            ...
            <h1 className="text-green-600">₹{totalPrice - finalPrice}/-</h1>
          </div>
          <div className="flex mt-2 text-lg font-semibold text-gray-600 justify-between">
            <h1>Shipping : </h1>
          ...
          <div className="flex mt-2 text-xl font-semibold  justify-between">
            <h1>To Pay : </h1>
            <h1>₹{finalPrice - ((5 / 100) * totalPrice).toFixed(2)}/-</h1>
          </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="flex items-center mt-8 bg-red-500 hover:bg-red-600 text-white font-bold py-3 px-6 rounded-lg shadow-lg transition-transform transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-red-300"
            >
              Clear Cart
