      ...
      {hasItems && productData ? (
        Cartdata.items.map((item, index) => (
          ...
          <div className="flex mt-14">
            <img className="border-2 shadow-xl rounded" src={item.productData.img} alt="" />
            <div className="ml-4">
              <h1 className="text-2xl font-normal text-gray-700">{item.productData.name}</h1>
              <h1 className="text-xl mt-2 text-gray-400">{item.productData.skinType}</h1>
              ...
              <div className="flex items-center mt-1 gap-4">
                <h1 className="text-2xl font-semibold">
                  ...
                  {item.productData.price -
                    (item.productData.price * (item.productData.discount / 100))}
                  /-
                </h1>
              ...
              <h1 className="text-base">
                Net content:{" "}
                <span className="font-semibold">{item.productData.quantity}ml</span>{" "}
                (usp:{" "}
